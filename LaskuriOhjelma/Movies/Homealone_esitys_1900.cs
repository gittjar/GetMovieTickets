...
{
    // Tämä on Home Alone esitys 19:00
	public class HomeAlone_esitys_1900
	{
       // class methods
        public static void HomeAlone_showtime_1900()
        {
           string movie = "Home Alone";
            ...
            AnsiConsole.Write(new BarChart()
                ...
                .Label($"[green bold underline]Esitysaika: {dt4_HA:d MMM yyyy} [/]"+"[green bold underline] klo 19:00 [/]")
                .CenterLabel()
                .AddItem("Vapaana", 36, Color.Green1)
                .AddItem("Varattu", 6, Color.Red1)
            ...
            var seats = AnsiConsole.Prompt(
                ...
                Console.WriteLine($"Aika: {dt4_HA:d MMM yyyy}" + " klo 19:00");
